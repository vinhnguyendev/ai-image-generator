    ...
    if(
      ...
      try {
        const response = await fetch(
          `https://pixolabai-server.onrender.com/api/v1/user`,
          {
            method: "POST",
            headers: {
      ...
      <div className="row w-100 align-items-center justify-content-center">
        ...
        >
          ...
          >
            ...
            {!matchPassword ? (
              <span className="mx-3 text-danger">Passwords do not match!</span>
            ) : null}
            <Form.Control
              required
              type="password"
          ...
          <div className="text-center">
            <a
              className="px-1"
              href="http://127.0.0.1:5500/client/public/policy.html"
            >
              Privacy policy
            </a>
          </div>
